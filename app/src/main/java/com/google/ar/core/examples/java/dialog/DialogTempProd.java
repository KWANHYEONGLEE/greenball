...
public class DialogTempProd {
    ...
    // 생성장 선언
    // 컨텍스트 연결
    public DialogTempProd(Context context) {this.context = context;}
    ...
    public void callDialog() {
        ...
        dig.setContentView(layout.dailog_responese);
        ...
        // 먹거리 체크박스
        final FrameLayout check_eat = (FrameLayout) dig.findViewById(R.id.check_eat);
        // 후식 버튼
        final LinearLayout img_btn_dessert = (LinearLayout)dig.findViewById(id.img_btn_dessert);
        // 후식 체크박스
        final FrameLayout check_dessert = (FrameLayout) dig.findViewById(R.id.check_dessert);
        // 놀거리 버튼
        final LinearLayout img_btn_playing = (LinearLayout) dig.findViewById(id.img_btn_playing);
        // 놀거리 체크박스
        final FrameLayout check_playing = (FrameLayout) dig.findViewById(R.id.check_playing);
        // 볼거리 버튼
        final LinearLayout img_btn_attraction = (LinearLayout)dig.findViewById(id.img_btn_attraction);
        // 볼거리 체크박스
        final FrameLayout check_attraction = (FrameLayout) dig.findViewById(R.id.check_attraction);

        btn_conf = (TextView) dig.findViewById(R.id.btn_conf);
