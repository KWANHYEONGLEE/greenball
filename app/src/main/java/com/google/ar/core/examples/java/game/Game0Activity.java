...
public class Game0Activity extends AppCompatActivity {
    private static final String TAG = Game0Activity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_answer.setOnClickListener(new Button.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent= new Intent(Game0Activity.this, Game1Next.class);
        ...
        // mediaplayer -> texture
        mediaPlayer = MediaPlayer.create(this, R.raw.test_pikachu);
                ...
                (HitResult hitResult, Plane plane, MotionEvent motionEvent) -> {
                    ...
                    model.setOnTouchListener(new Node.OnTouchListener() {
                        ...
                        public boolean onTouch(HitTestResult hitTestResult, MotionEvent motionEvent) {
                            Toast.makeText(Game0Activity.this, "아래캐릭터", Toast.LENGTH_SHORT).show();
                            return true;
