package com.google.ar.core.examples.java.monster;
 ...
 */
public class MonsterThreeActivity extends AppCompatActivity {
...
//                            renderable.getView("")
                            ...
                            textView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    ...
                                    if(textView.getText().equals("생각보다 잘 하는데??...")){
