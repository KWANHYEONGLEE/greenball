...
public class ep2_answer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ep2_answer = (EditText)findViewById(R.id.ep2_answer);
        ep2_answer.requestFocus();
        ...
        answer_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //공백 제거가 안돼.........
                String answer = ep2_answer.getText().toString().trim();
                if(answer.length() <= 0){
                    DialogNoAnswer dialogNoAnswer = new DialogNoAnswer(ep2_answer.getContext());
                    dialogNoAnswer.show();
                }
