...
public class ep4_answer extends AppCompatActivity {

    private ImageView back_game_card;
    private EditText ep4_answer_;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ep4_answer);
        ...
        ep4_answer_ = (EditText)findViewById(R.id.ep4_answer_);
        ep4_answer_.requestFocus();
        ...
        answer_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //공백 제거가 안돼.........
                String answer = ep4_answer_.getText().toString().trim();
                if(answer.length() <= 0){
                    DialogNoAnswer dialogNoAnswer = new DialogNoAnswer(ep4_answer_.getContext());
                    dialogNoAnswer.show();
                }
                    ...
                    //정답 맞췄을 때
                    if(answer.equals("52개") || answer.equals("52")){
                        Toast.makeText(ep4_answer.this, "정답", Toast.LENGTH_SHORT).show();
                    ...
                    //정답 아닐때
                        ...
                        startActivityC(ep4_wrong.class);
                    }
                }
            }
        });
