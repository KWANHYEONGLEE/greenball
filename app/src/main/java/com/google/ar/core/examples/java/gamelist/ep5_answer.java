...
public class ep5_answer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ep5_answer);
        ...
        ep5_answer_ = (EditText) findViewById(R.id.ep5_answer_);
        ep5_answer_.requestFocus();
        ...
        answer_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //공백 제거가 안돼.........
                String answer = ep5_answer_.getText().toString().trim();
                if (answer.length() <= 0) {
                    DialogNoAnswer dialogNoAnswer = new DialogNoAnswer(ep5_answer_.getContext());
                    dialogNoAnswer.show();
                } else {
                    ...
                    //정답 아닐때
                        ...
                        startActivityC(ep5_wrong.class);
                    }
                }
            }
        });
