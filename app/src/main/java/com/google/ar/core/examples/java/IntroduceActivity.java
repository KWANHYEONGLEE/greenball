...
public class IntroduceActivity extends AppCompatActivity {
    ...
    private void List_add() {
        List_sightseeing.add(new IntroduceItem("미디어 파사드", "자연의 빛과 남구를 상징하는 미디어 파사드. 색채와 소리를 활용한 풍부한 볼거리를 제공합니다.", "남구청사", "ereerererqrqwe", "", R.drawable.media));
        List_sightseeing.add(new IntroduceItem("원형공중정원", "도로 위 육교에 꽃과 나무를 심어 쉼 공간을 제공하는 원형공중정원입니다.", "백운광장", "ereerererqrqwe", "",  R.drawable.garden));
        List_sightseeing.add(new IntroduceItem("분수대", "낮에는 활기차게, 밤에는 분위기 있게 변신합니다.", "푸른길", "", "",  R.drawable.fountain));
        List_sightseeing.add(new IntroduceItem("로컬푸드 직매장", "광주 남구의 로컬 푸드를 구경하고 저렴하게 구매해보세요.", "스트리트 푸드존", "", "",  R.drawable.localfood));
        ...
        List_eating.add(new IntroduceItem("카츠샌드", "샌드위치 안에 야들야들한 고기가 들어있어요.", "스트리트 푸드존", "", "",  R.drawable.sandwitch));
        List_eating.add(new IntroduceItem("엉터리생고기", "삼겹살과 볶음밥을 스트리트 푸드존에서! 간단하게 즐겨봐요.", "스트리트 푸드존", "", "",  R.drawable.gogi));
        List_eating.add(new IntroduceItem("낙곱상점", "탱글탱글한 낙지와 고소한 곱창을 함께! 매콤한 낙곱전골 드시러오세요~", "스트리트 푸드존", "", "",  R.drawable.cube));
    }
